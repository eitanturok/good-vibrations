...
=======
    def __init__(self, patch_size:int, d_model:int, num_heads:int, num_layers:int, signal_length:int, freq_dropout:float, n_coords:int=2):
        super().__init__()
        self.embed = nn.Linear(n_coords * patch_size, d_model)
>>>>>>> Stashed changes
...
=======
        self.freq_encoder = FreqEncoder(data_info['patch_size'], d_model, pnt_num_heads, pnt_num_layers, data_info['n_freqs'], freq_dropout, data_info.get('n_coords', 2))
>>>>>>> Stashed changes
