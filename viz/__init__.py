"""
viz/__init__.py — Build a self-contained HTML viewer for dataset samples and W&B runs.

Usage:
    python viz/__init__.py --output artifacts/viewer.html
    python viz/__init__.py --runs s3pqt79j abc123 --output artifacts/viewer.html
"""
